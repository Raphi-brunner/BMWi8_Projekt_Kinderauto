...
#define LED_PIN      15   // GPIO-Pin → anpassen!
#define LED_NUM      60   // Anzahl LEDs
#define LED_HELLIGKEIT 180 // 0–255


//  LED-Bereiche auf dem Streifen
//  Streifen: [0..14] Front | [15..44] Mitte | [45..59] Heck
#define FRONT_START   0
#define FRONT_END     14   // 15 LEDs vorne
#define HECK_START    45
#define HECK_END      59   // 15 LEDs hinten
